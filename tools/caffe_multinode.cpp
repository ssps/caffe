...
int train() {
  LOG(INFO) << "Worker ID: " << FLAGS_worker_id;
  LOG(INFO) << "Number of workers: " << FLAGS_num_workers;
  LOG(INFO) << "LazyTable configs: " << FLAGS_ps_configs;
