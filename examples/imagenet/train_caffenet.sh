...
git show > $1/git-show
git diff > $1/git-diff
cp examples/imagenet/train_caffenet.sh $1/.
...
mpirun -machinefile examples/imagenet/8parts/machinefile ./build/tools/caffe_mpi train --solver=examples/imagenet/8parts/caffenet_solver.prototxt --ps_config=examples/imagenet/8parts/ps_config_caffenet \
