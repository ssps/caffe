...
mpirun -machinefile examples/imagenet/8parts/machinefile ./build/tools/caffe_mpi train --solver=examples/imagenet/8parts/googlenet_solver.prototxt --ps_config=examples/imagenet/8parts/ps_config \
--snapshot=/panfs/probescratch/BigLearning/hengganc/results/16-0112-1017-googlenet-snapshot/googlenet_snapshot_iter_70000 \
