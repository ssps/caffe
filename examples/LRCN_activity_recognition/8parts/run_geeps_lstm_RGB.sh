...
cp machinefile $1/.
cp ps_config $1/.
mpirun -machinefile machinefile ../../../build/tools/caffe_mpi train --solver=lstm_solver_RGB.prototxt --ps_config=ps_config --weights=../single_frame_all_layers_hyb_RGB_iter_5000.caffemodel
